...
import io.tehtotalpwnage.horseutils.configs.HorseList;
import io.tehtotalpwnage.horseutils.listeners.TamedHorseListener;
import io.tehtotalpwnage.horseutils.utils.PluginInfo;
...
public class HorseUtils {
	...
	public void onInitialization(GameInitializationEvent event) {
		...
		try {
			Sponge.getEventManager().registerListeners(this, new TamedHorseListener());
