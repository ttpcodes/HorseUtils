package io.tehtotalpwnage.horseutils.utils;
...
public class TranslationHelper {
	private static final Function<Locale, ResourceBundle> LOOKUP_FUNC = new Function<Locale, ResourceBundle>() {
		...
		public ResourceBundle apply(Locale input) {
			return ResourceBundle.getBundle("io.tehtotalpwnage.horseutils.lang.Locale", input);
		}
	};
	...
	public static Text t(String key, Locale locale, Object... args) {
		ResourceBundle bundle =  ResourceBundle.getBundle("io.tehtotalpwnage.horseutils.lang.Locale", locale);
