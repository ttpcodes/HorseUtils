package io.tehtotalpwnage.horseutils.lang;
...
public class Locale extends ListResourceBundle {
	...
	private Object[][] contents = {
		...
		{ "string.console.init" , "Loading HorseUtils version %s" },
		{ "string.console.initComplete" , "HorseUtils version %s loaded successfully." },
		...
		{ "string.console.preinit" , "Running preloading of HorseUtils version %s" },
